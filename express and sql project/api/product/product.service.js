...
class productService {
    ...
    async getProduct(page, pageSize) {
        return new Promise((resolve, reject) => {
            pool.query(
    ...
    updateProduct({ product_name, product_description, product_price, product_stock_quantity, product_category, product_brand, product_image_url }) {
